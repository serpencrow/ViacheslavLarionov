...
@Features({@Feature("Home page interface"), @Feature("Exercise1")})
@Listeners(AttachmentListener.class)
public class HomePageStepsTest extends AbstractBaseTest {
    ...
    public void homePageTest() {
        ...
        steps.homePageTitleShouldBe(HOME_PAGE_TITLE);
